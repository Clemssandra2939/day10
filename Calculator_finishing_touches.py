...
def calculator():
    ...
    # This concept in programming is called Recursion (Having a function that calls itself)

        if input(f"Type 'y' to continue calculating with {answer}, or type 'n' to refresh: ") == "y" :
            num1 = answer
        else:
            should_continue = False
            calculator() #this will basically take us bk to beginning where we get to enter the new input
